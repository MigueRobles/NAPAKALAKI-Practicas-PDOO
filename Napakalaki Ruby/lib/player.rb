...
module NapakalakiGame
  ...
  protected :canYouGiveMeATreasure, :giveMeATreasure, :getCombatLevel, :isDead, :getCanI, :getName, :getHiddenTreasures, :getVisibleTreasures, :getLevels, :getEnemy, :getPendingBadConsequence
  end
