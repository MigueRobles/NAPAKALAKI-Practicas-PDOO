...
public class CardDealer {
    ...
    private void initMonsterCardDealer() {
        ...
        prize = new Prize(2,1);
        unusedMonster.add(new Monster("Tongue", 19, prize, badConsequence));
        ...
        prize = new Prize(2,1);
        unusedMonster.add(new Monster("Bicéfalo", 21, prize, badConsequence));
        ...
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("Tenochtitlan", 2, prize, badConsequence));
        ...
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("El sopor de Dunwich", 2, prize, badConsequence));
        ...
        prize = new Prize(4,1);
        unusedMonster.add(new Monster("Demonios de Magaluf", 2, prize, badConsequence));
        
        badConsequence = new BadConsequence("Pierdes todos tus tesoros visibles",0, Integer.MAX_VALUE, 0);
        prize = new Prize(3,1);
        unusedMonster.add(new Monster("El gorrón en el umbral", 13, prize, badConsequence));
        ...
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("Necrófago", 13, prize, badConsequence));
               
        badConsequence = new BadConsequence("Pierdes 5 niveles y 3 tesoros visibles",5,3,0);
        prize = new Prize(3,2);
        unusedMonster.add(new Monster("El rey de rosado", 11, prize, badConsequence));
               
        badConsequence = new BadConsequence("Toses los pulmones y pierdes 2 niveles",2,0,0);
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("Flecher", 2, prize, badConsequence));
        ...
        prize = new Prize(2,1);
        unusedMonster.add(new Monster("Pollipólipo volante", 3, prize, badConsequence));
                   
        badConsequence = new BadConsequence("No le hace gracia que pronuncien mal su nombre. Estás muerto",true);
        prize = new Prize(3,1);
        unusedMonster.add(new Monster("Yskhtihyssg-Goth", 14, prize, badConsequence));
        ...
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("El espía sordo", 5, prize, badConsequence));
